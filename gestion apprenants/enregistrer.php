                    ...
                    <div class="col-md-6 mb-4">
                        <fieldset class="fieldcadre">
                            <div class="input-group champinput">
                                ...
                                <input type="tel" class="form-control inputborder" id="validationServerUsername" name="telephone" placeholder="entrer numéro de téléphone..." aria-describedby="inputGroupPrepend3" pattern="[0-9]{8,}" required>
                            </div>
                        </fieldset>
                    </div>
                    <div class="col-md-6 mb-4">
                ...
                <div class="col-md-6 mb-4">
                        <fieldset class="fieldcadre">
                            <div class="input-group champinput">
                                ...
                                <select class="form-control selectborder" id="validationServerUsername" name="genre"  aria-describedby="inputGroupPrepend3" pattern="[^\s]" required>
                    ...
                    <div class="col-md-12 mb-4">
                        <fieldset class="fieldcadre">
                            <div class="input-group champinputphoto">
                                ...
                                <input type="tel" class="form-control inputborder" id="validationServerUsername" name="telephoneTuteur" placeholder="entrer numéro de téléphone..." pattern="[0-9]{8,}" aria-describedby="inputGroupPrepend3" required>
                            </div>
                        </fieldset>
                    </div>
                </div>
